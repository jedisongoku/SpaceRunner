Shader "Battlehub/Nature/HB_SpeedTree Billboard"
{
	Properties
	{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			#include "../CGIncludes/HB_SpeedTreeBillboardCommon.cginc"
	...
	FallBack "Battlehub/Legacy Shaders/Transparent/Cutout/HB_VertexLit"
}
