Shader "Hidden/Nature/HB_Tree Creator Leaves Fast Optimized" {
Properties {
...
SubShader { 
	...
	CGPROGRAM
		...
		#include "../../CGIncludes/HB_UnityBuiltin3xTreeLibrary.cginc"
...
Dependency "BillboardShader" = "Hidden/Nature/HB_Tree Creator Leaves Rendertex"
}
