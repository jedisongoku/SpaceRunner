...
namespace InfiniteRunner.Player
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        public void LateUpdate()
        {
            ...
            if (curveTime != -1 && platformObject != null) {
                ...
                if (curveTime < 1 && followCurve) {
                    ...
                    futureCurvePoint.y = curvePoint.y = targetPosition.y + pivotOffset.y;
        ...
        // Turn left or right
        public bool Turn(bool rightTurn, bool fromInputController)
        {
            ...
            } else if (!fromInputController && !autoTurn && !gameManager.godMode && (!restrictTurns || Time.time - turnRequestTime > turnGracePeriod) &&
            ...
            // Do not allow a turn on a crossroads if within the grace period to prevent character from going back from where they came from.
            if (WithinReviveGracePeriod() && platformObject.straight) {
                return false;
            }
